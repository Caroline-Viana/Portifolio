        ...
        <>
            ...
            <section className='bio'>
                <ul className='bio_link'>
                    <li ><a href='https://www.linkedin.com/in/caroline-viana-de-medeiros/' ><LinkedInIcon sx={{ fontSize: 40, color: "#0F7D7E" }} /></a></li>
                    <li><a href='https://github.com/Caroline-Viana'><GitHubIcon sx={{ fontSize: 40, color: "#0F7D7E" }} /></a></li>
                    <li><a href='https://vercel.com/caroline-viana'><ChangeHistoryIcon sx={{ fontSize: 40, color: "#0F7D7E" }} className='oi'/></a></li>
                </ul>
